...
% Last Update: "2018-10-29 10:10:21 ban"
% ************************************************************
...
param.mask_orient_deg  = 67.5; % for masking, tilted orientation of the slant in deg, from right horizontal meridian, CCW

sparam.theta_deg    = sparam.theta_deg(25:1:32);
sparam.orient_deg   = sparam.orient_deg(25:1:32);
sparam.mask_type    = sparam.mask_type(25:1:32);
