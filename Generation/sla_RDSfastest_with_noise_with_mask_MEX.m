function [imgL,imgR]=sla_RDSfastest_with_noise_with_mask_MEX(posL,posR,wdot,bdot,dotalpha,dotDens,noise_psc,bgcolor,mask)
...
% mask        : (optional) if specified, imgL/imgR will be masked, [row,col]
%
% [output]
...
% Last Update: "2011-06-02 14:41:48 banh"
